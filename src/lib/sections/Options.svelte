...
<div class="relative h-10 max-sm:h-[105px] group px-11 __event max-sm:px-0">
	...
	{#if show}
		<div
			...
			out:box
			in:box={{ delay: 50 }}
			class="w-[500px] max-sm:w-[350px] bg-bg transition-none duration-0 origin-center flex flex-col items-center absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-[21] funding-box border border-white rounded-2xl max-sm:fixed max-sm:top-[50%] max-sm:left-[50%] max-sm:-translate-x-[50%] max-sm:-translate-y-[50%]"
		>
			<div
