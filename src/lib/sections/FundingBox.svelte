...
<div class="group relative flex flex-col items-center h-[105px] __event max-sm:h-[140px]">
	...
	{#if show}
		<div
			...
			out:box
			in:box={{ delay: 50 }}
			class="transition-none duration-0 origin-center absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-[21] border border-white rounded-2xl funding-box max-sm:fixed max-sm:w-[350px] max-sm:max-h-[85vh] max-sm:overflow-y-auto"
		>
			<div
