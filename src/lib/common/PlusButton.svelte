<script lang="ts">
	...
	import AcceleratorModal from '$lib/sections/AcceleratorModal.svelte';
	...
	let showMenu = false;
	let showAcceleratorModal = false;
...
{#if showAcceleratorModal}
	<AcceleratorModal {position} onClose={() => (showAcceleratorModal = false)} />
{/if}
